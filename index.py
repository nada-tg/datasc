...
PLATFORMS = [
    {"name": "Accélérateur de Particules", "slug": "accelerateur_particules", "port": 8001, "icon": "⚛️", "type": "streamlit"},
    {"name": "Télescope Avancé", "slug": "advanced_telescope_platform", "port": 8002, "icon": "🔭", "type": "streamlit"},
    {"name": "Connecteur IA", "slug": "ai_connector", "port": 8003, "icon": "🔗", "type": "streamlit"},
    {"name": "Plateforme de Décision IA", "slug": "ai_decision_platform", "port": 8004, "icon": "🧠", "type": "streamlit"},
    {"name": "Développement IA", "slug": "ai_development_platform", "port": 8005, "icon": "💻", "type": "streamlit"},
    # {"name": "Cycle de Vie IA", "slug": "ai_lifecycle", "port": 8006, "icon": "♻️", "type": "streamlit"},
    {"name": "IA Quantique Biocomputing", "slug": "ai_quantique_biocomputing", "port": 8007, "icon": "🧬", "type": "streamlit"},
    {"name": "Plateforme AR/VR", "slug": "arvr_platform", "port": 8008, "icon": "🥽", "type": "streamlit"},
    {"name": "Plateforme ASI", "slug": "asi_platform", "port": 8009, "icon": "🤖", "type": "streamlit"},
    {"name": "Véhicule Autonome", "slug": "autonomous_vehicle", "port": 8010, "icon": "🚗", "type": "streamlit"},
    # {"name": "AutoSci Pipeline", "slug": "autosci_pipeline", "port": 8011, "icon": "🔬", "type": "streamlit"},
    {"name": "Organoïde Cérébral", "slug": "brain_organoid_platform", "port": 8012, "icon": "🧠", "type": "streamlit"},
    {"name": "Tokenisation Business", "slug": "business_tokenization", "port": 8013, "icon": "💰", "type": "streamlit"},
    {"name": "Collisionneur de Particules", "slug": "collisionneur_particules", "port": 8014, "icon": "💥", "type": "streamlit"},
    {"name": "Conscience Artificielle", "slug": "conscience_artificielle", "port": 8015, "icon": "🌟", "type": "streamlit"},
    {"name": "Directeur de Conversation", "slug": "conversation_director", "port": 8016, "icon": "💬", "type": "streamlit"},
    {"name": "Intelligence Cosmique", "slug": "cosmic_intelligence", "port": 8017, "icon": "🌌", "type": "streamlit"},
    # {"name": "Cybersécurité", "slug": "cybersecurite", "port": 8018, "icon": "🔒", "type": "streamlit"},
    {"name": "Cybersécurité Quantique Bio", "slug": "cybersecurite_quantique_bio", "port": 8019, "icon": "🛡️", "type": "streamlit"},
    {"name": "Matière Noire", "slug": "dark_matter_platform", "port": 8020, "icon": "🌑", "type": "streamlit"},
    {"name": "Plateforme Data", "slug": "data_platform", "port": 8021, "icon": "📊", "type": "streamlit"},
    {"name": "Datacenter", "slug": "datacenter_platform", "port": 8022, "icon": "🖥️", "type": "streamlit"},
    {"name": "Plateforme Énergie", "slug": "energy_platform", "port": 8023, "icon": "⚡", "type": "streamlit"},
    {"name": "Entraînement IA", "slug": "entrainement_ai", "port": 8024, "icon": "🎯", "type": "streamlit"},
    {"name": "Plateforme Fusion", "slug": "fuse_plateform", "port": 8025, "icon": "🔥", "type": "streamlit"},
    {"name": "Laboratoire Fusion Nucléaire", "slug": "fusion_nuclear_lab", "port": 8026, "icon": "☢️", "type": "streamlit"},
    {"name": "Multivers Holographique", "slug": "holographic_multiverse", "port": 8027, "icon": "🌐", "type": "streamlit"},
    {"name": "IA Générale", "slug": "intelligence_artificielle_generale", "port": 8028, "icon": "🧩", "type": "streamlit"},
    {"name": "Intrication Quantique", "slug": "intrication_quantique", "port": 8029, "icon": "🔗", "type": "streamlit"},
    {"name": "Certification ISO", "slug": "iso_certification", "port": 8030, "icon": "📜", "type": "streamlit"},
    {"name": "Intelligence Média", "slug": "media_intelligence_platform", "port": 8031, "icon": "📺", "type": "streamlit"},
    {"name": "Matière Exotique Neuromorphique", "slug": "neuromorphic_exotic_matter", "port": 8032, "icon": "🧪", "type": "streamlit"},
    {"name": "Réacteur Nucléaire", "slug": "nuclear_reactor", "port": 8033, "icon": "⚛️", "type": "streamlit"},
    {"name": "Optimisation", "slug": "optimisation", "port": 8034, "icon": "📈", "type": "streamlit"},
    {"name": "Optimisation Quantique Bio", "slug": "optimisation_quantique_bio", "port": 8035, "icon": "🔬", "type": "streamlit"},
    {"name": "Plateforme de Test", "slug": "plateforme_test", "port": 8036, "icon": "🧪", "type": "streamlit"},
    {"name": "IA Quantique", "slug": "quantique_ia", "port": 8037, "icon": "⚛️", "type": "streamlit"},
    {"name": "Physique Quantique", "slug": "quantum_physics_platform", "port": 8038, "icon": "🔮", "type": "streamlit"},
    {"name": "Robotique", "slug": "robotique", "port": 8039, "icon": "🦾", "type": "streamlit"},
    {"name": "Mécanique Spatiale", "slug": "space_mechanics", "port": 8040, "icon": "🚀", "type": "streamlit"},
    {"name": "Supercalculateur", "slug": "supercalculateur", "port": 8041, "icon": "💻", "type": "streamlit"},
    {"name": "Supraconducteur", "slug": "supraconducteur", "port": 8042, "icon": "⚡", "type": "streamlit"},
    {"name": "Optimiseur Système", "slug": "system_optimizer", "port": 8043, "icon": "⚙️", "type": "streamlit"},
    {"name": "Test IA", "slug": "test_ai", "port": 8044, "icon": "🧪", "type": "streamlit"},
    {"name": "Tokenizer IA", "slug": "tokenizer_ai", "port": 8045, "icon": "🔤", "type": "streamlit"},
    {"name": "Conservation Ultra", "slug": "ultra_conservation_platform", "port": 8046, "icon": "🌍", "type": "streamlit"},
]
